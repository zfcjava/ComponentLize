...
public class Constants {
    ...
    // 注解处理器中支持的注解类型
    public static final String AROUTER_ANNOTATION_TYPES = "com.canjun.arouter_annotation.ARouter";
    public static final String PARAMETER_ANNOTATION_TYPES = "com.canjun.arouter_annotation.Parameter";
